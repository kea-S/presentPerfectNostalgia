function NavBar() {
    ...
    return (
        <div className="box-content w-36 sm:w-60 md:w-96 xl:w-150 h-60">
            <div className="h-20 md:h-40 flex">
                <div className="flex basis-2/3 p-3">
                    <a className="border flex-1 flex justify-center items-center font-normal no-underline text-current
                        hover:no-underline hover:text-current bg-black p-1"
                        href="/KeaHarvanSuyanto_Resume.pdf"
                        download>
                        <h6 className="text-xs md:text-base">Resume</h6>
                    </a>
                </div>
                <div className="flex h-16 md:h-32 basis-1/3 self-end p-3">
                    <a className="border flex-1 flex justify-center items-center font-normal no-underline text-current
                        hover:no-underline hover:text-current bg-black p-1"
            ...
            <div className="h-14 md:h-20 flex justify-around">
